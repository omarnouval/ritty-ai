    ...
    <main className="min-h-screen" style={{ background: 'rgb(8, 9, 23)' }}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            <h1 className="text-3xl font-heavy text-white">Marketplace</h1>
            <p className="text-sm text-gray-500 mt-1">Deploy, discover & rent autonomous AI agents</p>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-24 glass rounded-2xl">
            ...
            <Link href="/create" className="inline-flex items-center gap-2 text-sm font-medium text-white px-6 py-2.5 rounded-full" style={{ background: 'rgba(249,115,22,0.8)' }}>
              List your agent →
            </Link>
          </div>
        ) : (
